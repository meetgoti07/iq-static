			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Info Quotient</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Info Quotient</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://2f79c46f.iq-static.pages.dev/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
